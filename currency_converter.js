...
async function myBanner() {
    showBanner('Currency Converter', 'Here you can convert any currency to any currency');
}
...
let data = await fetch("https://openexchangerates.org/api/latest.json?app_id=97330f53db4d4596b8e10fdbb51d198e")
    .then((value) => value.json())
    .then((data) => data.rates);
async function fromCurrency() {
...
async function currencyConversion(to, from, amount) {
